...
const fixedPositions = [
  ...
  { name: "Wonn", position: [-0.5 * SCALE_FACTOR * X_STRETCH_FACTOR, 0.9 * SCALE_FACTOR, 0.3 * SCALE_FACTOR] },
  { name: "Sikstee", position: [-0.2 * SCALE_FACTOR * X_STRETCH_FACTOR, 0.9 * SCALE_FACTOR, 0.7 * SCALE_FACTOR] },
  { name: "AT-2", position: [0.3 * SCALE_FACTOR * X_STRETCH_FACTOR, 0.9 * SCALE_FACTOR, -0.3 * SCALE_FACTOR] },
  { name: "Hun", position: [0.7 * SCALE_FACTOR * X_STRETCH_FACTOR, 0.9 * SCALE_FACTOR, 0.8 * SCALE_FACTOR] },
  ...
  { name: "NT-9", position: [-0.2 * SCALE_FACTOR * X_STRETCH_FACTOR, -0.2 * SCALE_FACTOR, -0.2 * SCALE_FACTOR] },
  { name: "Minuss", position: [0.1 * SCALE_FACTOR * X_STRETCH_FACTOR, -0.2 * SCALE_FACTOR, 0.4 * SCALE_FACTOR] },
  { name: "Forti", position: [0.5 * SCALE_FACTOR * X_STRETCH_FACTOR, -0.1 * SCALE_FACTOR, -0.9 * SCALE_FACTOR] },
  { name: "Dreddand", position: [0.8 * SCALE_FACTOR * X_STRETCH_FACTOR, -0.3 * SCALE_FACTOR, 0.1 * SCALE_FACTOR] },
  { name: "Thurt", position: [-0.9 * SCALE_FACTOR * X_STRETCH_FACTOR, -0.8 * SCALE_FACTOR, -0.7 * SCALE_FACTOR] },
